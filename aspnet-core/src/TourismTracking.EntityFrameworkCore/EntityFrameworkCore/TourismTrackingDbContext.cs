...
public class TourismTrackingDbContext :
    AbpDbContext<TourismTrackingDbContext>,
    IIdentityDbContext,
    ITenantManagementDbContext
{
    ...
    public TourismTrackingDbContext(DbContextOptions<TourismTrackingDbContext> options)
        : base(options)
    {
    ...
    protected override void OnModelCreating(ModelBuilder builder)
    {
        ...
        builder.Entity<Destination>(b => {
            b.ToTable("AppDestinations");
            b.ConfigureByConvention(); // auto configure for auditing, soft delete, etc
        });

        builder.Entity<Experience>(b => {
            b.ToTable("AppExperiences");
